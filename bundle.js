...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".book-btn {\n  align-self: center;\n  padding: 5px;\n  margin: 5px;\n}\n\n.booking-card {\n  background-color: rgba(199, 173, 143, 0.85);\n}\n\n.dashboard {\n  display: grid;\n  grid-template-columns: 300px 300px 300px 300px;\n}\n.dashboard section {\n  min-width: 300px;\n  padding: 10px;\n}\n\n.dashboard-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background-color: rgba(109, 143, 182, 0.85);\n  color: white;\n}\n\n.date-selector {\n  width: 200px;\n  text-align: center;\n}\n\n.new-booking-form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 10px, 10px, 0px, 10px;\n  min-height: 100px;\n}\n.new-booking-form section {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  min-width: auto;\n}\n\n.room-card, .booking-card {\n  margin: 10px;\n  padding: 10px;\n  box-shadow: 3px 3px 3px rgba(0, 0, 0, 0.8);\n}\n.room-card p, .booking-card p {\n  padding: 3px;\n}\n\n.room-card {\n  display: flex;\n  flex-direction: column;\n  background-color: rgba(182, 148, 109, 0.85);\n  cursor: pointer;\n  border-radius: 10px;\n}\n\n.section-heading {\n  padding: 10px;\n  text-align: center;\n}\n\n.total-spent,\n.total-spent-heading {\n  text-align: center;\n}\n\n.type {\n  display: block;\n}\n\nheader {\n  display: flex;\n  justify-content: center;\n}\nheader span {\n  padding: 20px;\n  width: 300px;\n  font-family: \"Cinzel Decorative\", cursive;\n  font-size: 72px;\n  color: white;\n  background-color: rgba(109, 143, 182, 0.85);\n}\n\n.login-btn {\n  margin: 10px;\n  padding: 10px;\n  color: white;\n  background-color: rgba(182, 148, 109, 0.85);\n  cursor: pointer;\n}\n\n.login-error-box p {\n  padding: 5px;\n}\n\n.login-form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  align-items: center;\n  height: auto;\n  padding: 20px;\n  width: 300px;\n  font-size: 18px;\n  text-align: center;\n  color: white;\n  background-color: rgba(109, 143, 182, 0.85);\n  border-radius: 0 0 10% 10%;\n}\n.login-form input {\n  margin: 10px;\n  text-align: center;\n}\n.login-form input:focus::placeholder {\n  color: white;\n}\n.login-form article {\n  padding: 10px;\n  text-align: center;\n}\n\nmain {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  align-items: center;\n  width: 90%;\n}\n\n.main-heading {\n  padding-top: 20px;\n  font-family: \"Cinzel Decorative\", cursive;\n  text-align: center;\n}\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  font-family: sans-serif;\n}\n\nbody {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  height: 100vh;\n  width: 100vw;\n  color: white;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: cover;\n}\n\n.hidden {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/css/dashboard.scss","webpack://./src/css/base.scss","webpack://./src/css/mixins.scss","webpack://./src/css/variables.scss","webpack://./src/css/header.scss","webpack://./src/css/login.scss","webpack://./src/css/main.scss"],"names":[],"mappings":"AAGA;EACE,kBAAA;EACA,YAAA;EACA,WAAA;ACFF;;ADKA;EACE,2CAAA;ACFF;;ADKA;EACE,aAAA;EACA,8CAAA;ACFF;ADIE;EACE,gBAAA;EACA,aAAA;ACFJ;;ADMA;EEtBE,aAAA;EACA,sBAAA;EACA,mBAAA;EFsBA,2CGxBK;EHyBL,YAAA;ACDF;;ADIA;EACE,YAAA;EACA,kBAAA;ACDF;;ADIA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,8BAAA;EACA,iBAAA;ACDF;ADGE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,eAAA;ACDJ;;ADKA;EACE,YAAA;EACA,aAAA;EACA,0CG9CO;AF4CT;ADGE;EACE,YAAA;ACDJ;;ADKA;EACE,aAAA;EACA,sBAAA;EACA,2CG3DI;EH4DJ,eAAA;EACA,mBAAA;ACFF;;ADKA;EACE,aAAA;EACA,kBAAA;ACFF;;ADKA;;EAEE,kBAAA;ACFF;;ADKA;EACE,cAAA;ACFF;;AGzEA;EACE,aAAA;EACA,uBAAA;AH4EF;AG1EE;EACE,aAAA;EACA,YAAA;EACA,yCAAA;EACA,eAAA;EACA,YDRI;ECSJ,2CDXG;AFuFP;;AIrFA;EACE,YAAA;EACA,aAAA;EACA,YFHM;EEIN,2CFLI;EEMJ,eAAA;AJwFF;;AIpFE;EACE,YAAA;AJuFJ;;AInFA;EHhBE,aAAA;EACA,sBAAA;EACA,mBAAA;EGgBA,mBAAA;EACA,YAAA;EACA,aAAA;EACA,YAAA;EACA,eAAA;EACA,kBAAA;EACA,YFtBM;EEuBN,2CFzBK;EE0BL,0BAAA;AJwFF;AItFE;EACE,YAAA;EACA,kBAAA;AJwFJ;AItFI;EACE,YF/BE;AFuHR;AIpFE;EACE,aAAA;EACA,kBAAA;AJsFJ;;AK3HA;EJFE,aAAA;EACA,sBAAA;EACA,mBAAA;EIEA,mBAAA;EACA,UAAA;ALgIF;;AK7HA;EACE,iBAAA;EACA,yCHFa;EGGb,kBAAA;ALgIF;;AArIA;EACE,sBAAA;EACA,SAAA;EACA,uBAAA;AAwIF;;AArIA;ECZE,aAAA;EACA,sBAAA;EACA,mBAAA;EDYA,aAAA;EACA,YAAA;EACA,YEdM;EFeN,yDAAA;EACA,sBAAA;AA0IF;;AAvIA;EACE,aAAA;AA0IF","sourcesContent":["@use 'variables' as *;\n@use 'mixins' as *;\n\n.book-btn {\n  align-self: center;\n  padding: 5px;\n  margin: 5px;\n}\n\n.booking-card {\n  background-color: lighten($tan, 10%);\n}\n\n.dashboard {\n  display: grid;\n  grid-template-columns: 300px 300px 300px 300px;\n\n  section {\n    min-width: 300px;\n    padding: 10px;\n  }\n}\n\n.dashboard-container {\n  @include columnCentered();\n  background-color: $blue;\n  color: white;\n}\n\n.date-selector {\n  width: 200px;\n  text-align: center;\n}\n\n.new-booking-form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 10px, 10px, 0px, 10px;\n  min-height: 100px;\n\n  section {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    min-width: auto;\n  }\n}\n\n.room-card, .booking-card {\n  margin: 10px;\n  padding: 10px;\n  box-shadow: $shadow;\n  p {\n    padding: 3px;\n  }\n}\n\n.room-card {\n  display: flex;\n  flex-direction: column;\n  background-color: $tan;\n  cursor: pointer;\n  border-radius: 10px;\n}\n\n.section-heading {\n  padding: 10px;\n  text-align: center;\n}\n\n.total-spent,\n.total-spent-heading {\n  text-align: center;\n}\n\n.type {\n  display: block;\n}\n","@use 'dashboard' as *;\n@use 'header' as *;\n@use 'login' as *;\n@use 'main' as *;\n@use 'mixins' as *;\n@use 'variables' as *;\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  font-family: sans-serif;\n}\n\nbody {\n  @include columnCentered();\n  height: 100vh;\n  width: 100vw;\n  color: $white;\n  background-image: url(\"../images/oasis.jpg\");\n  background-size: cover;\n}\n\n.hidden {\n  display: none;\n}\n","@mixin columnCentered() {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n","// Colors\n$blue: hsla(212, 33%, 57%, 0.85);\n$tan: complement($blue);\n$white: hsla(0, 0%, 100%, 1);\n\n// Effects\n$shadow: 3px 3px 3px rgb(0 0 0 / 0.8);\n\n// Fonts\n$primary-font: 'Cinzel Decorative', cursive;\n","@use 'variables' as *;\n\nheader {\n  display: flex;\n  justify-content: center;\n\n  span {\n    padding: 20px;\n    width: 300px;\n    font-family: $primary-font;\n    font-size: 72px;\n    color: $white;\n    background-color: $blue;\n  }\n}\n","@use 'variables' as *;\n@use 'mixins' as *;\n\n.login-btn {\n  margin: 10px;\n  padding: 10px;\n  color: $white;\n  background-color: $tan;\n  cursor: pointer;\n}\n\n.login-error-box {\n  p {\n    padding: 5px;\n  }\n}\n\n.login-form {\n  @include columnCentered();\n  align-items: center;\n  height: auto;\n  padding: 20px;\n  width: 300px;\n  font-size: 18px;\n  text-align: center;\n  color: $white;\n  background-color: $blue;\n  border-radius: 0 0 10% 10%;\n\n  input {\n    margin: 10px;\n    text-align: center;\n\n    &:focus::placeholder {\n      color: $white;\n    }\n  }\n\n  article {\n    padding: 10px;\n    text-align: center;\n  }\n}\n","@use 'variables' as *;\n@use 'mixins' as *;\n\nmain {\n  @include columnCentered();\n  align-items: center;\n  width: 90%;\n}\n\n.main-heading {\n  padding-top: 20px;\n  font-family: $primary-font;\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
